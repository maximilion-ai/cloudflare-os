...
<p>Authorization complete. You may close this tab and return to Garten.</p></body></html>`;
...
const INVALID_LINK_HTML = page("Authorization Link Expired", "#d97706",
  "This authorization link is invalid or has expired. Please return to Garten and try again.");
...
export class GatekeeperVendor extends WorkerEntrypoint<Env> implements GatekeeperVendorIface {
  async describe(): Promise<VendorDescription> {
    return {
      ...
      description:
        "Connect your Atlassian Confluence site to let Garten search, read, and edit the pages, " +
