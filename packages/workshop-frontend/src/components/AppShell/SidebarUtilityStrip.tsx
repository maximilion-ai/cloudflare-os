    ...
    <Tooltip
      ...
      render={(
        <button
          ...
          className="flex h-8 w-8 cursor-pointer items-center justify-center rounded-md text-kumo-inactive transition-colors hover:bg-kumo-tint hover:text-kumo-default focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-kumo-ring focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--color-rail)]"
        >
          {themeMode === 'system' ? (
            <Desktop size={15} />
          ) : themeMode === 'dark' ? (
  ...
  return (
    <div
      className={[
        ...
        'rail shrink-0 flex items-center gap-1 border-t border-kumo-line px-2.5 py-2',
