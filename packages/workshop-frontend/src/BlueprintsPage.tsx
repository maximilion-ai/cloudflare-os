      ...
      <header className="flex items-end justify-between gap-4 px-3 pb-4 pt-6 sm:pt-10">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-[13px] leading-[18px] tracking-[-0.25px] text-kumo-subtle">
            Start from a template. Open one to grow a new space from it, or save it for later.
          </p>
        </div>
          ...
          <EmptySection
            ...
            message={
              search
                ...
                : "Featured templates will appear here when they’re published. You can still create templates from your own spaces."
            }
          />
        ) : view === "grid" ? (
