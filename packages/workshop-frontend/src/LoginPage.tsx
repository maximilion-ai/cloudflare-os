    ...
    <div className="relative flex h-full min-h-0 flex-col items-center justify-start overflow-y-auto bg-kumo-base px-4 py-8">
      ...
      <div className="relative my-auto w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          <SiteLogo size={44} className="mb-4">
            <GartenMark size={44} className="mb-4" />
          </SiteLogo>
          <h1 className="text-[28px] font-semibold text-kumo-default">{siteName}</h1>
          <p className="text-sm text-kumo-subtle mt-1">Welcome back. Sign in to your garden.</p>
        </div>
